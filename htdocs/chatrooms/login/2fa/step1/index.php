        ...
        if(!empty($_POST['email_restart'])){
                ...
                if(!is_bool($lfdu)){
                        ...
                        if(mysqli_num_rows($lfdu) != 0){
                                ...
                                $txt = "It looks like you have requested to create an account on " . $serverconfig['server_name'] . ". The account's username is " . stripslashes(htmlspecialchars($lfdu_RSLT['username'])) . ".\n\n
                                ...
                                $headers = "From: " . $serverconfig["admin_email"];
